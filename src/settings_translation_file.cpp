...
fake_function() {
	...
	gettext("If enabled and you have ContentDB packages installed, HeroCraft may contact ContentDB to\ncheck for package updates when opening the mainmenu.");
	gettext("ContentDB Flag Blacklist");
	gettext("Comma-separated list of flags to hide in the content repository.\n\"nonfree\" can be used to hide packages which do not qualify as 'free software',\nas defined by the Free Software Foundation.\nYou can also specify content ratings.\nThese flags are independent from HeroCraft versions,\nso see a full list at https://content.HeroCraft.org/help/content_flags/");
	...
	gettext("URL to JSON file which provides information about the newest HeroCraft release.\nIf this is empty the engine will never check for updates.");
	gettext("Server");
	gettext("Admin name");
	...
	gettext("Number of threads to use for mesh generation.\nValue of 0 (default) will let HeroCraft automatically choose the number of threads.");
	...
	gettext("Windows systems only: Start HeroCraft with the command line window in the background.\nContains the same information as the file debug.txt (default name).");
