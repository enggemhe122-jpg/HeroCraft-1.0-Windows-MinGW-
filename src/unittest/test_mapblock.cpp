...
public:
	...
	// Tests loading a MapBlock from HeroCraft-c55 0.3
...
void TestMapBlock::testSave29(IGameDef *gamedef)
{
	...
	/*
	 * Quick note:
	 * HeroCraft deals with MapBlocks that violate these invariants (mostly) fine,
...
// The array was generated with: HeroCraftmapper -i testworld --dumpblock 6,0,0 |
...
void TestMapBlock::testLoadNonStd(IGameDef *gamedef)
{
	 ...
	 * transition to 16-bit: <https://github.com/HeroCraft-org/HeroCraft/commit/ea62ee4b61371107ef3d693bda4c410ba02ca7e6>
