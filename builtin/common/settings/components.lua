...
local PLATFORM = PLATFORM or core.get_platform()
local INIT = INIT or core.get_init_type()
...
--- @param validator function, optional. Returns true when valid.
	...
	return function(setting)
		return {
			...
			get_formspec = function(self, avail_w)
				...
				fs = fs ..
					("button[%f,0.3;1.5,0.8;%s;%s]"):format(avail_w - 1.5, "set_" .. setting.name, fgettext("Set"))
