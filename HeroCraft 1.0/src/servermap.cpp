	...
	m_emerge(emerge)
{
	...
	*/
	...
	m_save_time_counter = mb->addCounter(
		"HeroCraft_map_save_time", "Time spent saving blocks (in microseconds)");
	m_save_count_counter = mb->addCounter(
		"HeroCraft_map_saved_blocks", "Number of blocks saved");
	m_loaded_blocks_gauge = mb->addGauge(
		"HeroCraft_map_loaded_blocks", "Number of loaded blocks");
