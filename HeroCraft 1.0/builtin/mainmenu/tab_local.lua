...
local function get_formspec(tabview, name, tabdata)
	...
	if #pkgmgr.games == 0 then
		...
		local hypertext = "<global valign=middle halign=center size=18>" ..
				fgettext_ne("HeroCraft is a game-creation platform that allows you to play many different games.") .. "\n" ..
				fgettext_ne("HeroCraft doesn't come with a game by default.") .. " " ..
